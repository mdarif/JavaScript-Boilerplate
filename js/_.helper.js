        ...
        function _helper() {
            ...
            */
            this.removeInfo = function (name, checkCookie) {
             ...
             /*
             * Gets count of all parent level key value pairs from json object
             * Accept single parameter object
             *      object : object is the Json object
            ...
            */
            this.getLength = function (object) {
             ...
             /*
             * Gets all key parameters from unknows json object
             * Accept single parameter object
             *      object : object is the Json object
            ...
            */
            ...
            /*
             * Gets all meta parameters from current page
            ...
            */
            this.currentActiveElement = function(elem){
                $(window, "body").on('scroll', function(event) {
                    ...
                    elem.each(function(index, el) {
                        var visibleAtTop = $(el).offset().top + $(el).height() >= $(window).scrollTop(),
                            visibleAtBottom = $(el).offset().top <= $(window).scrollTop() + $(window).height();
                        if (visibleAtTop && visibleAtBottom) {
                            if(_allScrollFn[index] != undefined){
                                _allScrollFn[index]();
                                _allScrollFn.splice(index, 1);
                            }
                        }
                    });
                });
            ...
            /*
             * Stores functions in an array based on index passed
             *      Accept two parameters fn and i
             *      fn : fn is function which needs to be called on certain scroll index of element passed in currentActiveElement
